# AGENTS.md — `template_autopoiesis/output/manuscript`
...
- Files: `00_abstract.md`, `01_introduction.md`, `02_methods.md`, `03_results.md`, `04_honesty.md`, `05_reproducibility.md`, `06_limitations.md`, `99_references.md`, `config.yaml`, `preamble.md`, `references.bib`
