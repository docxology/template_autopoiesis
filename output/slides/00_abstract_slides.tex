...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\%\% noqa: docs{-}lint — \{\{...\}\} tokens are manuscript{-}variable placeholders}
\NormalTok{\%\% (src/manuscript\_variables.py) injected at render time, not literal mermaid}
