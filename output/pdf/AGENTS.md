# AGENTS.md — `template_autopoiesis/output/pdf`
...
Rendered PDF deliverables, including <name>_combined.pdf and compile logs.

## Layout

- Files: `template_autopoiesis_combined.pdf`
